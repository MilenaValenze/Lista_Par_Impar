...
/*Relatório: Testando a execução do código, constatei que há uma falha em um caso específico de entrada. Quando o primeiro número é par, exclusivamente, e há uma sequência de outros pares, a lista impressa não mostra o último número par da sequência, isto se não ouver outro número ímpar fora o '999' que finaliza o laço de repetição.*/
